...
- `netcup install-mcp --scope project|local` writes `.agents/skills/netcup` plus host MCP configs (no plugin/marketplace install)
...
[Unreleased]: https://github.com/brandonkramer/netcup-cli/compare/v0.2.3...HEAD
[0.2.3]: https://github.com/brandonkramer/netcup-cli/compare/v0.2.2...v0.2.3
